...
@Repository
public class MongoDBCocktailRepository implements CocktailRepository {
    ...
    @Inject
    public MongoDBCocktailRepository(@Value("${mongodb.uri}") String mongoUri, @Value("${solr.url}") String solrUri)
