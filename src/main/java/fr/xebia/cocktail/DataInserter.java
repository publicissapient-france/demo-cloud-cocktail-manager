...
public class DataInserter {
    ...
    private final static Logger logger = LoggerFactory.getLogger(DataInserter.class);

    public static void main(String[] args) throws Exception {
        try {
            new DataInserter().initializeRepository();
        } catch (Exception e) {
    ...
    public void initializeRepository() throws Exception {
        ...
        MongoDBCocktailRepository cocktailRepository = new MongoDBCocktailRepository("mongodb://localhost:27017/devoxxfr-demo",
